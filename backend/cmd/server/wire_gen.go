...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	schedulerService := scheduler.ProvideService(schedulerSQLRepository, suppliersService, extensionService, suppliergroupsService, ratesService, balancesService, healthService, usagecostsService, channelchecksService, purityService, sessionsService)
	...
	kanbanService := kanban.NewServiceWithAllDependencies(kanbanSQLRepository, sitecatalogService, schedulerService)
	...
	actionsService := actions.NewServiceWithDependencies(actionsSQLRepository, suppliersService)
