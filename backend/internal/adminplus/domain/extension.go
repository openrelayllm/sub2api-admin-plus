...
func (t ExtensionTaskType) Valid() bool {
	switch t {
	case ExtensionTaskTypeFetchRates, ExtensionTaskTypeFetchBalance, ExtensionTaskTypeFetchPromotions, ExtensionTaskTypeExportBills, ExtensionTaskTypeFetchHealth:
		return true
	default:
		return false
	}
