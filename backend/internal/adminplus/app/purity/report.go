...
func buildPublicSummary(report *PublicReport) map[string]any {
	...
	if report.TokenAudit != nil {
		out["token_audit"] = map[string]any{
			...
			"billing_multiplier":            report.TokenAudit.BillingMultiplier,
			"billingMultiplier":             report.TokenAudit.BillingMultiplierCompat,
			"billing_multiplier_source":     report.TokenAudit.BillingMultiplierSource,
			"billingMultiplierSource":       report.TokenAudit.BillingMultiplierSourceCompat,
			"cache_hit_rate":                report.TokenAudit.CacheHitRate,
			"cached_tokens_field_observed":  report.TokenAudit.CachedTokensFieldObserved,
			"cache_creation_field_observed": report.TokenAudit.CacheCreationFieldObserved,
			"cache_read_field_observed":     report.TokenAudit.CacheReadFieldObserved,
			"prompt_cache_key":              report.TokenAudit.PromptCacheKey,
			"store_enabled":                 report.TokenAudit.StoreEnabled,
			"context_replay_rounds":         report.TokenAudit.ContextReplayRounds,
			"context_replay_links":          report.TokenAudit.ContextReplayLinks,
			"context_replay_links_expected": report.TokenAudit.ContextReplayLinksExpected,
			"context_replay_ok":             report.TokenAudit.ContextReplayOK,
			"history_replay_rounds":         report.TokenAudit.HistoryReplayRounds,
			"history_replay_links":          report.TokenAudit.HistoryReplayLinks,
			"history_replay_links_expected": report.TokenAudit.HistoryReplayLinksExpected,
			"history_replay_ok":             report.TokenAudit.HistoryReplayOK,
