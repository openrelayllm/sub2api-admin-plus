...
export ADMIN_PLUS_DEV_RESET_ADMIN_PASSWORD="${ADMIN_PLUS_DEV_RESET_ADMIN_PASSWORD:-true}"
if [ -z "${ADMIN_PLUS_PROXY_MIHOMO_BINARY_PATH:-}" ]; then
  ADMIN_PLUS_PROXY_MIHOMO_BINARY_PATH="$(bash "${ROOT_DIR}/scripts/ensure-mihomo.sh")"
fi
export ADMIN_PLUS_PROXY_MIHOMO_BINARY_PATH
...
Admin Plus backend
  ...
  mihomo:   ${ADMIN_PLUS_PROXY_MIHOMO_BINARY_PATH}
